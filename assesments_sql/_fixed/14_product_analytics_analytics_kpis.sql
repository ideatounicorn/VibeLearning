...
BEGIN
    ...
    INSERT INTO questions (
        ...
        E'Robinhood reports that overall ARPU (Average Revenue Per User) has declined from $50 to $40 over the last quarter. However, the data table shows:\n\n| Cohort | Q1 ARPU | Q2 ARPU |\n|--------|---------|---------|\n| Crypto | $80     | $85     |\n| Options| $120    | $125    |\n| Stocks | $20     | $22     |\n\nWhat is the most likely mathematical explanation?',
        'intermediate',
        'Robinhood',
